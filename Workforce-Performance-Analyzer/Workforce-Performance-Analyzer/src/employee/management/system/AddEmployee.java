...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee() {
        ...
        labeldoj.setBounds(400, 400, 150, 30);
        ...
        JLabel labelaadhar = new JLabel("Date of joining");
       ...
       dcaadhar = new JDateChooser();
       dcaadhar.setBounds(600, 350, 150, 30);
        add(dcaadhar);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            String aadhar = ((JTextField) dcaadhar.getDateEditor().getUiComponent()).getText();
